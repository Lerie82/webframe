...
Author: Lerie Taylor
Date: 2021
Filename: plugins/MyBlogTemplate.class.php
Description: blog template
*/
class MyBlogTemplate
{
      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-md-block" src="'.$this->t_config->strings->thumbnail1.'" alt="Card image cap">
          </div>
        </div>
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 box-shadow h-md-250">
            ...
            <img class="card-img-right flex-auto d-none d-md-block" src="'.$this->t_config->strings->thumbnail2.'" alt="Card image cap">
          </div>
        </div>
      </div>
    </div>
